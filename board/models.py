...
def board_directory_path(instance, filename):
    return 'board_images/{}/{}_{}'.format(instance.board.ctg, datetime.today().strftime('%Y-%m-%d-%H-%M-%S'), '.png')
...
class Post(models.Model):
    ...
    img = models.ImageField(null=True, blank=True, upload_to=board_directory_path)
